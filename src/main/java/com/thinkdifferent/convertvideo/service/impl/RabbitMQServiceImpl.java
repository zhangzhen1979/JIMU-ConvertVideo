...
import static com.thinkdifferent.convertvideo.config.RabbitMQConfig.DELAY_EXCHANGE_RETRY;
import static com.thinkdifferent.convertvideo.config.RabbitMQConfig.DELAY_ROUTING_RECEIVE_RETRY;
...
public class RabbitMQServiceImpl implements RabbitMQService, RabbitTemplate.ConfirmCallback {
     ...
     * @see com.thinkdifferent.convertvideo.controller.IndexController#listError()
     */
    @Override
